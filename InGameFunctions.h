...
void(*CustomizeSetInBackRoom)(bool IsInBackroom) = (void(*)(bool))0x575B10;
...
unsigned int(__thiscall* IconOption_SetFEngObject)(DWORD* IconOption, DWORD* FEObj) = (unsigned int(__thiscall*)(DWORD*, DWORD*))0x573270;
...
int(__thiscall* RideInfo_SetRandomPaint)(void* RideInfo) = (int(__thiscall*)(void*))0x759800;
...
bool(__thiscall* CarCustomizeManager_IsPartLocked_Game)(DWORD* CarCustomizeManager, DWORD* SelectablePart, int Unk) = (bool(__thiscall*)(DWORD*, DWORD*, int))0x7A4E50;
...
void (__cdecl* FEngSetScript_obj)(DWORD* FEObject, unsigned int ScriptHash, bool) = (void (__cdecl*)(DWORD*, unsigned int, bool))0x514D10;
void (__cdecl* FEngGetTopLeft_obj)(DWORD* FEObject, float* x, float* y) = (void (__cdecl*)(DWORD*, float*, float*))0x514FD0;
void (__cdecl* FEngSetTopLeft_obj)(DWORD* FEObject, float x, float y) = (void (__cdecl*)(DWORD*, float, float))0x524CC0;
...
bool(__cdecl* Physics_Upgrades_CanInstallJunkman)(DWORD* PVehicle, int UpgradeType) = (bool(__cdecl*)(DWORD*, int))0x677FE0;
...
void(__thiscall* CustomizeMain_SwitchRooms_Game)(DWORD* CustomizeMain) = (void(__thiscall*)(DWORD*))0x7BFC50;
...
bool(* UnlockSystem_IsBackroomAvailable)(int eUnlockFilters, int UnlockableID, int UpgradeLevel) = (bool(*)(int, int, int))0x58AA90;
...
int(*MapPerfPkgToUnlockable)(int PerfPkgType) = (int(*)(int))0x5769C0;
...
bool(__thiscall* cFrontendDatabase_IsCarStableDirty)(DWORD* cFrontendDatabase) = (bool(__thiscall*)(DWORD*))0x57FC90;
void(*RaceStarter_StartCareerFreeRoam)() = (void(*)())0x56C5B0;
void(__thiscall* GarageMainScreen_UpdateCurrentCameraView)(DWORD* GarageMainScreen, bool unk) = (void(__thiscall*)(DWORD*, bool))0x7A94C0;
int(__thiscall* FEMarkerManager_GetNumCustomizeMarkers)(DWORD* FEMarkerManager) = (int(__thiscall*)(DWORD*))0x58AE50;
bool(__thiscall* FEMarkerManager_IsMarkerAvailable)(DWORD* FEMarkerManager, int, int) = (bool(__thiscall*)(DWORD*, int, int))0x576ED0;
bool(__thiscall* FEMarkerManager_GetNumMarkers)(DWORD* FEMarkerManager, int, int) = (bool(__thiscall*)(DWORD*, int, int))0x576F10;
bool(__thiscall* CarCustomizeManager_CanInstallJunkman)(DWORD* FEMarkerManager, int PerformancePartType) = (bool(__thiscall*)(DWORD*, int))0x7A56A0;
...
int(__thiscall* CustomizeHUDColor_BuildColorOptions_Game)(void* _CustomizeHUDColor) = (int(__thiscall*)(void*))0x7B7AC0;